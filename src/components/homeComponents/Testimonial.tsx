...
const testimonials: Testimonial[] = [
  {
    ...
    quote: "As Kinsta's first Head of Sales Development, Nicole Coetzer was tasked with building outbound sales from scratch. Using Apollo to find the right leads in less time, her growing team hit a consistent 36% connection rate, helping them exceed quota every single month.",
    stat: "36%",
  ...
  },
  {
    ...
    logo: "arbolus",
    image: "/assets/image29.webp",
    quote: "I use Apollo for everything — prospecting, messaging, even the dialer. It's where I spend most of my day, and it has made my workflow so much more efficient."
  },
  {
    id: 3,
    category: "SDRS",
    ...
    logo: "CYERA",
    image: "/assets/image29.webp",
    quote: "Having Apollo be our all-in-one system was a game changer for the BDRs. The average number of meetings booked increased by 75% once we made the move over to Apollo.",
    stat: "75%",
  ...
  },
  {
    ...
    logo: "Census",
    image:"/assets/image29.webp",
    quote: "When Census's data quality issues started to sabotage their sales team, Head of Growth Sylvain Giuliani made a bold move: replacing their entire tech stack with Apollo. This switch set their go-to-market team up for unprecedented growth, with 4x more contact data while cutting platform costs by 64%.",
    stat: "50%",
  ...
  },
  {
    ...
    logo: "PR",
    image: "/assets/image29.webp",
    quote: "Predictable Revenue's CEO Collin Stewart was struggling with an expensive, complex tech stack. By switching to Apollo as their all-in-one platform, they cut costs by 50% while doubling email open rates and cutting time to meeting in half.",
    stat: "50%",
          ...
          <div className="flex gap-4">
            ...
            >
              <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
                <path d="M12.027 3.52704L8.00479 7.54927C6.49981 9.05275 7.56583 11.6252 9.69341 11.6252L21.5692 11.6208V12.3673L9.69042 12.3718C7.56434 12.3718 6.49831 14.9443 8.00329 16.4477L12.0285 20.473L11.5 21L2.49997 12L11.5 3L12.0285 3.52704H12.027Z" fill="currentColor"/>
              </svg>
            </button>
            <button
            ...
            >
              <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
                <path d="M12.0421 3.52704L16.0644 7.54927C17.5693 9.05275 16.5033 11.6252 14.3757 11.6252L2.5 11.6208V12.3673L14.3787 12.3718C16.5048 12.3718 17.5708 14.9443 16.0659 16.4477L12.0406 20.473L12.5692 21L21.5692 12L12.5692 3L12.0406 3.52704H12.0421Z" fill="currentColor"/>
              </svg>
            </button>
          </div>
        </div>
