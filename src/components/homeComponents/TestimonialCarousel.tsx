...
export default function TestimonialCarousel() {
    ...
    const testimonials: Testimonial[] = [
        {
            company: "Mebit.com",
            quote: "The biggest benefit of Intercom is that it has everything you need to create a great experience for your customers and your support team. Literally, anything you need, you can find in the platform. My advice to anyone considering Intercom is to just do it. You won't regret it.",
    ...
    return (
        <div>
            ...
            <div className="mx-auto px-3 max-w-[1000px] lg:w-[82%] lg:max-w-[1492px]  w-full flex flex-col justify-center items-center gap-4 md:gap-6 my-20">
                <h2
                ...
                <div className="w-full flex flex-col justify-center items-center gap-4 md:gap-6 pb-6">
                    ...
                    <div className="relative w-full" style={{ minHeight: '450px' }}>
                        {displayOrder.map(({ testimonial, originalIndex, stackPosition }) => {
                            const isActive = stackPosition === 0;

                            return (
                                <div
                                    key={originalIndex}
                                    className={`absolute left-0 right-0 transition-all duration-500 ease-out ${stackPosition < 3 ? 'opacity-100' : 'opacity-0 pointer-events-none'
                                        }`}
                                    style={{
