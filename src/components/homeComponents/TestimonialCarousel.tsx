...
export default function TestimonialCarousel() {
  ...
  return (
    <div className="mx-auto px-3 max-w-[1000px] lg:w-[82%] lg:max-w-[1492px] my-4 md:my-5 w-full flex flex-col justify-center items-center gap-4 md:gap-6">
      <h2 
            ...
            return (
              <div
                ...
                className={`absolute left-0 right-0 transition-all duration-500 ease-out ${
                  stackPosition < 3 ? 'opacity-100' : 'opacity-0 pointer-events-none'
                }`}
                style={{
