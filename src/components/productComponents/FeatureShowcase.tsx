...
const FEATURE_CATEGORIES: FeatureCategory[] = [
    {
        ...
        features: [
            ...
            },
            {
                ...
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" fill="none">
                        <path d="M2 12.1886C2 11.6363 2.44772 11.1886 3 11.1886H10C10.5523 11.1886 11 11.6363 11 12.1886C11 12.7409 10.5523 13.1886 10 13.1886H3C2.44772 13.1886 2 12.7409 2 12.1886Z" fill="currentColor" />
                        <path d="M2 7.1886C2 6.63631 2.44772 6.1886 3 6.1886H21C21.5523 6.1886 22 6.63631 22 7.1886C22 7.74088 21.5523 8.1886 21 8.1886H3C2.44772 8.1886 2 7.74088 2 7.1886Z" fill="currentColor" />
                        <path d="M2 17.1886C2 16.6363 2.44772 16.1886 3 16.1886H10C10.5523 16.1886 11 16.6363 11 17.1886C11 17.7409 10.5523 18.1886 10 18.1886H3C2.44772 18.1886 2 17.7409 2 17.1886Z" fill="currentColor" />
                        <path d="M21.0429 10.5224C20.8012 10.5298 20.5723 10.6421 20.4034 10.8343C18.9311 12.4721 17.5872 14.0777 16.1737 15.6805L14.5119 14.2013C14.3193 14.0299 14.0734 13.9506 13.8281 13.9808C13.5822 14.0111 13.3582 14.1482 13.2037 14.3627C13.0499 14.5765 12.9784 14.8495 13.0057 15.1218C13.0329 15.3948 13.1565 15.6435 13.3491 15.815L15.6747 17.8804C16.0465 18.2085 16.5807 18.1742 16.915 17.7997C18.5877 15.9388 20.0866 14.1105 21.7212 12.2919C21.9943 11.9941 22.0755 11.5409 21.9259 11.1503C21.7757 10.759 21.4256 10.5103 21.0429 10.5224Z" fill="currentColor" />
                    </svg>
                ),
                color: 'text-[#105BCC]',
                learnMoreLink: '/product/search',
        ...
        features: [
            {
                id: 'meetings',
                title: 'Meetings',
                description: 'Schedule and manage meetings efficiently with automated coordination.',
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" fill="none">
...
const FeaturesShowcase = () => {
    const [activeFeature, setActiveFeature] = useState(FEATURE_CATEGORIES[0]?.features[0]?.id || '');
