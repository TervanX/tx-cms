    ...
    >
      <div className="container mx-auto px-4">
        <div
          ...
          }  items-center gap-8 lg:gap-12 py-6 lg:py-18`}
        >
          {/* Text Content */}
...
export const featuresData: FeatureItemDetailed[] = [
  {
    ...
    description: (
      <>
        ...
        <Link
          href="/product/ai-sales-automation"
          className="hover:border-b-2  hover:border-[#fecf40]"
        >
          AI-powered sales automation
        </Link>
        , tap into real-time{" "}
        <Link
          href="/product/buying-intent"
          className="hover:border-b-2  hover:border-[#fecf40]"
        >
          buying intent
        </Link>
  ...
  },
  {
    ...
    description: (
      <>
        Access verified contact and company data across Salesforce, Gmail, and
        Outlook. Enrich your records in real time with{" "}
        <Link
          href="/product/data-enrichment"
          className="hover:border-b-2  hover:border-[#fecf40]"
        >
  ...
  },
  {
    ...
    description: (
      <>
        Identify every decision-maker in an account and engage them with
        precision. Apollo's
        <Link
          href="/product/data-enrichment"
          className="hover:border-b-2  hover:border-[#fecf40]"
        ...
        make it easy to spot opportunities, personalize outreach, and close
  ...
  },
  {
    ...
    description: (
      <>
        Let AI surface the highest-fit leads based on your past success.
        Apollo's
        <Link
          href="/product/data-enrichment"
          className="hover:border-b-2  hover:border-[#fecf40]"
