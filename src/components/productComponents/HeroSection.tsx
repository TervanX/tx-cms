...
export function HeroSection({
  ...
  return (
    <div className={`relative min-h-screen overflow-hidden font-grotesque ${className}`}>
      {/* Background Pattern */}
