        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-14 py-12">
                ...
                <section className="mb-16">
                    <div className="mb-8">
                        <h2 className="text-2xl font-medium text-gray-900 mb-2">Core Pricing Breakdown</h2>
                        <p className="text-gray-600">Pay only for what you use with our flexible pricing model</p>
                    </div>
                            ...
                            <table className="w-full">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Unit Cost</th>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                    ...
                    <div className="border border-[#E5E7EB] rounded-xl p-8 bg-white">
                        <div className="mb-6">
                            <h2 className="text-2xl font-medium text-gray-900 mb-2">Starter Bundle</h2>
                            <p className="text-gray-600">Perfect for teams launching MVPs and testing payment rails</p>
                        </div>
                        <div className="flex items-baseline justify-between mb-6">
                            <h3 className="text-xl font-medium text-gray-900">{starterBundle.price}</h3>
                    ...
                    <div className="border border-[#E5E7EB] rounded-xl p-8 bg-white">
                        <div className="mb-6">
                            <h2 className="text-2xl font-medium text-gray-900 mb-2">Free Tier</h2>
                            <p className="text-gray-600">Start building immediately with our sandbox environment</p>
                        </div>
                        <div className="mb-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                    ...
                    <div className="border border-[#E5E7EB] rounded-xl p-6 bg-white">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-xl font-medium text-gray-900">Safeguards & Security</h2>
                        </div>
                        <p className="text-gray-600 mb-4">Enterprise-grade security measures to protect your operations</p>
                    ...
                    <div className="border border-[#E5E7EB] rounded-xl p-6 bg-white">
                        <div className="flex items-center gap-3 mb-4">
                            <Info size={20} className="text-gray-600" />
                            <h2 className="text-xl font-medium text-gray-900">Developer Features</h2>
                        </div>
                        <p className="text-gray-600 mb-4">Tools and infrastructure designed for developers</p>
                        <ul className="space-y-3">
                ...
                <section className="mb-16">
                    <div className="mb-8">
                        <h2 className="text-2xl font-medium text-gray-900 mb-2">Who It's For</h2>
                        <p className="text-gray-600">Ideal for teams building customer-facing financial applications</p>
                    </div>
                ...
                <section className="mb-16">
                    <div className="mb-8">
                        <h2 className="text-2xl font-medium text-gray-900 mb-2">TervanX Add-Ons</h2>
                        <p className="text-gray-600">Enhance your plan with modular extensions for scalability, compliance, and deeper integration.</p>
                    </div>
                    <div className="border border-[#E5E7EB] rounded-xl overflow-hidden">
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead className="bg-gray-50">
                                    <tr>
                                        <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Add-On</th>
                                        <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Description</th>
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {addOns.map((addon, index) => (
                                        <tr key={index} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-900 font-medium whitespace-pre-line">{addon.price}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
