...
const WhatAreCredits: React.FC = () => {
  const creditFeatures = [
    {
      icon: (
        ...
        >
          <path
            fill="currentColor"
            d="M17.889 12.502c0 .92-.746 1.666-1.666 1.666H1.778c-.92 0-1.666-.746-1.667-1.666V6.609l1.389.946v4.947c0 .153.125.277.278.277h14.445a.278.278 0 0 0 .277-.277V7.506l1.389-.946v5.942ZM16.223.835c.92 0 1.666.747 1.666 1.667v2.04l-6.16 4.197-1.418.947a2.362 2.362 0 0 1-2.62 0l-4.859-3.24-2.72-1.854v-2.09c0-.92.746-1.667 1.666-1.667h14.445ZM1.778 2.224a.279.279 0 0 0-.278.278v1.387l6.96 4.64a.973.973 0 0 0 1.08 0l6.96-4.64V2.502a.278.278 0 0 0-.277-.278H1.778Z"
          ></path>
        </svg>
      ),
      title: "Email",
    ...
    },
    {
      ...
      credits: "8 credits",
      description:
        "Access verified phone numbers and directly connect with your prospects.",
    },
    {
      icon: (
        <svg
        ...
        >
          <path
            d="M30.5558 16.0003H28.3336C28.3336 9.37288 22.961 4.0003 16.3336 4.0003C12.888 4.0003 9.78166 5.45243 7.59308 7.77808H11.8891V10.0003H3.66688V1.77808H5.88911V6.34695C8.48724 3.53727 12.205 1.77808 16.3336 1.77808C24.1883 1.77808 30.5558 8.14558 30.5558 16.0003Z"
            fill="currentColor"
          ></path>
          <path
            d="M2.11133 16.0003H4.33355C4.33355 22.6277 9.70613 28.0003 16.3336 28.0003C19.7791 28.0003 22.8854 26.5482 25.074 24.2225H20.778V22.0003H29.0002V30.2225H26.778V25.6536C24.1799 28.4633 20.4621 30.2225 16.3336 30.2225C8.47883 30.2225 2.11133 23.855 2.11133 16.0003Z"
            fill="currentColor"
          ></path>
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M21.6669 16.0003C21.6669 18.9458 19.2791 21.3336 16.3336 21.3336C13.388 21.3336 11.0002 18.9458 11.0002 16.0003C11.0002 13.0548 13.388 10.667 16.3336 10.667C19.2791 10.667 21.6669 13.0548 21.6669 16.0003ZM19.4447 16.0003C19.4447 17.7185 18.0518 19.1114 16.3336 19.1114C14.6153 19.1114 13.2224 17.7185 13.2224 16.0003C13.2224 14.2821 14.6153 12.8892 16.3336 12.8892C18.0518 12.8892 19.4447 14.2821 19.4447 16.0003Z"
            fill="currentColor"
          ></path>
        </svg>
      ),
      ...
      credits: "1-8 credits",
      description:
        "Enhance your contact profiles with enriched data for better targeting.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Get insights with AI: identify prospects' pain points, engage contacts, and refine filters.",
    },
  ];
  ...
  return (
    <div
      id="what-are-credits"
      className="flex w-full flex-col items-start gap-12 overflow-hidden bg-white px-5 lg:px-[calc(100%*(1/26))] min-[1250px]:flex-row min-[1250px]:items-center my-12"
    >
      {/* Left Content */}
        ...
        <div className="relative hidden flex-shrink-0 md:flex">
          <div className="flex items-center justify-center">
            <img
              ...
              height="155"
              decoding="async"
              src="https://res.cloudinary.com/dx1etzf66/image/upload/v1761889000/coin_i6xbzs.svg"
          ...
          <div>
            <img
              ...
              height="235"
              decoding="async"
              src="https://res.cloudinary.com/dx1etzf66/image/upload/v1761891556/connections.c01ce8ba_vubdmm.svg"
              style={{ color: "transparent" }}
            />
          </div>
        </div>
