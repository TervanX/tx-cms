...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    name: "Basic / Starter",
    description:
      "Perfect for small businesses or startups (e.g., African e-commerce, payment apps).",
    price: 1990,
    monthlyPrice: 199,
    priceNote: "per year",
    ...
    features: [
      ...
      "LayerX dashboard with basic analytics",
    ...
    detailInfo: {
      ...
      compliance: [
        "50 KYC checks/month (powered by LayerX Identity)",
  ...
  },
  {
    ...
    detailInfo: {
      ...
      idealForDescription:
        "Mid-sized fintechs, crypto payment gateways, neobanks, and digital asset platforms needing deeper automation, advanced compliance, and scalable wallet orchestration across multiple chains and countries.",
      coreInfrastructure: [
      ...
      dashboard: [
        "LayerX Dashboard (Pro Edition) with advanced analytics",
  ...
  },
  {
    ...
    name: "Enterprise",
    description:
      "For large exchanges, banks, custodians with custom requirements.",
    price: 20000,
    monthlyPrice: 2000,
    priceNote: "starting at per year (custom pricing)",
    ...
    detailInfo: {
      ...
      idealForDescription:
        "Global exchanges, digital banks, custodians, infrastructure providers, and large-scale financial institutions that require full-stack control, compliance assurance, and custom deployment of financial and crypto infrastructure.",
      coreInfrastructure: [
...
export const comparisonData: ComparisonSection[] = [
  {
    items: [
      ...
      },
      {
        ...
        values: [
          "Testnet",
          "Basic KYT, 50 KYC checks/month",
          "Real-time KYT, 200 KYC checks/month",
      ...
      },
      {
        ...
        values: [
          ...
          "Advanced (dynamic rules + risk scoring)",
        ],
      },
      {
        ...
        values: [
          ...
          "Auto-Trade, Webhooks, batch transactions",
          "Full automation + smart triggers",
        ],
      },
      {
        ...
        values: [
          "Testnet",
          "-",
          "DeFi API + 20+ blockchains",
          "Full multi-chain + private nodes",
        ],
      },
      {
