    ...
    <section className="px-6 md:px-12 lg:px-16 xl:px-20 2xl:px-24">
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-10 lg:grid-cols-2">
        <div className="flex flex-col items-start justify-center text-left">
          <h1 className="mb-6 text-balance font-founders-grotesk text-[56px] leading-[90%] tracking-[-1.12px] text-black md:text-[72px] md:tracking-[-1.44px] lg:text-[80px] lg:tracking-[-1.6px] xl:text-[88px] xl:tracking-[-1.76px]">
