...
export default function Banner({
  ...
  backgroundImage = "https://res.cloudinary.com/dx1etzf66/image/upload/v1761889003/helpdesk-ctabanner_ogrzvq.webp.webp",
  backgroundImageLQIP = "https://res.cloudinary.com/dx1etzf66/image/upload/v1761889003/helpdesk-ctabanner_ogrzvq.webp-lqip.webp",
  altText = "CTA Banner",
}: BannerProps) {
  return (
      ...
      >
        <div
          style={{
            ...
            transform: "translateY(-38.4417px)",
          }}
        >
