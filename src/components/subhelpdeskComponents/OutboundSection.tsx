...
import { OutboundSectionProps } from "@/app/types/productNav.type";
            ...
            <div className="flex flex-col items-start gap-4 bg-transparent xl:gap-12 @3xl:grid @3xl:grid-cols-[minmax(0,300px)_1fr] @3xl:justify-between">
              ...
              <div className="@3xl:col-start-1 @3xl:row-start-1 @3xl:mt-auto">
                ...
                <a
                  ...
                  href={g2Comparison.link.href}
                  target={g2Comparison.link.target || "_self"}
                >
                  <span className="external-link-inner inline-flex items-center">
                    {g2Comparison.link.text}
  ...
  return (
    <li>
      <div className="flex flex-col items-center gap-4 text-center xl:gap-5">
        <span
          className={`relative z-10 flex [height:clamp(80px,calc(80px_+_20_*_((100vw_-_330px)_/_50)),100px)] [width:clamp(80px,calc(80px_+_20_*_((100vw_-_330px)_/_50)),100px)] items-center justify-center rounded-full font-serif text-5xl font-light tracking-[-2.88px] lg:size-[150px] lg:text-[4.5rem] xl:size-[190px] xl:text-[5.25rem] ${item.color}`}
        >
