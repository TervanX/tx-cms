    ...
    featureLinks = [
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" fill="none">
                    <path fill="#fff" fillRule="evenodd" d="M3 1.016a2 2 0 0 0-2 2v9.5a2.5 2.5 0 0 0 2.5 2.5h9a2.5 2.5 0 0 0 2.5-2.5v-9.5a2 2 0 0 0-2-2zm10 1.7H3a.3.3 0 0 0-.3.3v6.7a.3.3 0 0 0 .3.3h2.5c.276 0 .494.227.562.495a2 2 0 0 0 3.876 0c.068-.268.286-.495.562-.495H13a.3.3 0 0 0 .3-.3v-6.7a.3.3 0 0 0-.3-.3" clipRule="evenodd" />
                </svg>
            )
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="copilot_svg__inline-block">
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" fill="none">
                    <path fill="#fff" fillRule="evenodd" d="M14 1.016a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-3.522A6.503 6.503 0 0 0 3 7.118V3.016a2 2 0 0 1 2-2zm-.375 2.102a.75.75 0 0 1 .75 1.3l-3.5 2.02a2.75 2.75 0 0 1-2.75 0l-3.5-2.02a.75.75 0 1 1 .75-1.3l3.5 2.021a1.25 1.25 0 0 0 1.25 0z" clipRule="evenodd" />
                    <path fill="#fff" d="m5.21 15.117 2.5-2.5a.85.85 0 0 0 0-1.202l-2.5-2.5a.85.85 0 0 0-1.202 1.202l1.049 1.049H.979a.85.85 0 1 0 0 1.7h4.078l-1.049 1.049a.85.85 0 0 0 1.202 1.202" />
                </svg>
            )
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" fill="none">
                    <g clipPath="url(#help-center_svg__a)">
                        <path fill="#fff" fillRule="evenodd" d="M16 8.016a8 8 0 1 1-16 0 8 8 0 0 1 16 0m-8.056-3.06c-.467 0-.867.295-1.02.71a.75.75 0 0 1-1.407-.518 2.587 2.587 0 1 1 4.4 2.564l-.016.02-.018.019-.819.84-.005.007-.005.005c-.242.24-.36.38-.36.643v.277a.75.75 0 0 1-1.5 0v-.277c0-.915.532-1.44.793-1.697l.008-.008.792-.815a1.086 1.086 0 0 0-.844-1.77zm0 7.454a.673.673 0 1 0 0-1.346.673.673 0 0 0 0 1.346" clipRule="evenodd" />
                    </g>
                    <defs>
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" fill="none">
                    <path fill="#fff" d="M14.25 4.516a2.75 2.75 0 1 1-5.5 0 2.75 2.75 0 0 1 5.5 0M4.5 14.266a2.75 2.75 0 1 0 0-5.5 2.75 2.75 0 0 0 0 5.5M10 9.016a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1zM3 2.016a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1z" />
                </svg>
            )
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" fill="none">
                    <path fill="#fff" fillRule="evenodd" d="M3 1.016a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-10a2 2 0 0 0-2-2zm9.5 5a1.5 1.5 0 1 0-1.312-.772L9.525 8.016H9.5q-.202.001-.389.05L7.95 6.905A1.502 1.502 0 0 0 6.5 5.016a1.5 1.5 0 0 0-1.312 2.228l-1.663 2.772H3.5a1.5 1.5 0 1 0 1.312.772l1.663-2.772H6.5q.202-.001.388-.05l1.163 1.161A1.502 1.502 0 0 0 9.5 11.016a1.5 1.5 0 0 0 1.312-2.228l1.663-2.772z" clipRule="evenodd" />
                </svg>
            )
        },
        {
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="none">
                    <path fill="#fff" d="m14.449 4.733-2.705 10.095a1.451 1.451 0 0 1-2.428.65l-2.052-2.052a1 1 0 0 1-.16-1.207l1.719-2.976c.247-.429-.232-.908-.66-.66L5.185 10.3a1 1 0 0 1-1.207-.159L1.926 8.09a1.451 1.451 0 0 1 .65-2.428l10.096-2.705a1.451 1.451 0 0 1 1.777 1.777" />
                </svg>
            )
        }
    ],
