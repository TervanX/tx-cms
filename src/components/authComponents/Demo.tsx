...
export default function Demo() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center overflow-hidden bg-white rounded-md pt-12">
      {/* Background Pattern */}
      <Image
        src="https://res.cloudinary.com/dx1etzf66/image/upload/v1761891864/bg.1_sqoiji.svg"
        alt="demo"
        fill
        priority
      ...
      <div className="relative z-10 w-full max-w-xl px-8">
        ...
        <div className="space-y-8 py-6">
          <div className="relative flex w-full flex-col">
            <div
              className={`flex items-center rounded-lg bg-white h-12 px-3 border ${
            ...
            {error && (
              <label className="mt-2 flex items-center gap-2 text-sm text-red-600">
                ...
                >
                  ...
                  <path
                    d="M9 13C9.55229 13 10 12.5523 10 12C10 11.4477 9.55229 11 9 11C8.44772 11 8 11.4477 8 12C8 12.5523 8.44772 13 9 13Z"
                    fill="#B21D1D"
                  ></path>
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 13.4183 4.58172 17 9 17ZM9 15.75C12.7279 15.75 15.75 12.7279 15.75 9C15.75 5.27208 12.7279 2.25 9 2.25C5.27208 2.25 2.25 5.27208 2.25 9C2.25 12.7279 5.27208 15.75 9 15.75Z"
                    fill="#B21D1D"
                  ></path>
                </svg>
        ...
        <div className="mt-6 flex items-center justify-center gap-2 flex-col md:flex-row">
          ...
          <p className="text-sm text-gray-700">4.7/5 based on 9,015 reviews</p>
        </div>
      </div>
    </div>
  );
