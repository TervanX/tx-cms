    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ maskImage: 'linear-gradient(to bottom, transparent, transparent 10%, black 35%)' }}
            >
                <div className="absolute inset-0 z-10 flex size-full items-end overflow-hidden">
                    <div className={`pointer-events-none absolute inset-0 z-10 items-end transition-opacity duration-500 ${isHovering && videoSrc ? 'opacity-0 lg:flex' : 'opacity-100 lg:flex'}`}>
...
It enables businesses, developers, and financial institutions to build crypto apps, manage millions of wallets, and automate operations securely."
                    ...
                    imageSrc="/assets/suite-placeholder.webp"
