        ...
        fields: [
            {
                ...
                options: [
                    ...
                    "Ivory Coast", "Madagascar", "Cameroon", "Niger", "Senegal", "Zimbabwe",
                    "Tunisia", "Zambia", "Other"
                ]
            },
            {
                name: "useCase",
        ...
        fields: [
            {
                ...
                label: "Why You're Interested in TervanX Switch (Optional)",
                placeholder: "Tell us what you plan to build or any specific use cases..."
            },
            {
                name: "referralCode",
                type: "text" as const,
...
const mobileHeading = {
    title: "Join TervanX Switch Waitlist",
    description: "Be among the first to access our next-generation digital asset infrastructure. Get early access and exclusive updates."
};
