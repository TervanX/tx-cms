                        ...
                        <blockquote className="bg-[#D1ECFF] p-4 text-left">
                            <div className="mb-4">
                                <p className="font-serif text-lg md:text-xl leading-relaxed text-gray-800">
                                    Scaling to meet customer demand has never been easier — TervanX ensures seamless performance, uptime, and compliance at every transaction.
                                </p>
                            </div>
                            <footer className="text-left border-t p-4 ">
                                <span className="font-semibold text-gray-900 block">Jeff Cardoso</span>
                                <span className="text-sm text-gray-600">Vice President Operations, Azazie</span>
                            </footer>
                        </blockquote>
                    </div>
