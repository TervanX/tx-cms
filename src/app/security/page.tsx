                ...
                <div className="container mx-auto px-4 py-8 ">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-xl text-gray-600 mb-6 max-w-4xl">
                            Tervan X upholds the highest standards for safety and security, including
                            enterprise-grade testing and controls, internationally recognized compliance
                            accreditations, and advanced protections for AI agents against LLM threats.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-700">security@tervanx.com</span>
                            </div>
                            <Link
                ...
                <div className="max-w-6xl mx-auto">
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <p className="text-gray-600 mb-4">
                                            At Tervan X, security is embedded in every layer of our platform.
                                            We maintain rigorous security practices to protect your data and ensure
                    ...
                    {activeTab === 'compliance' && (
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                                <h3 className="text-xl font-semibold text-gray-900 mb-6">Additional Compliance</h3>
                                <div className="grid md:grid-cols-3 gap-4">
                                    ...
                                    <div className="text-center p-4 border border-gray-200 rounded-lg">
                                        <div className="text-2xl font-bold text-gray-900 mb-2">&lt; 1h</div>
                    ...
                    {activeTab === 'resources' && (
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                            ...
                            <p className="text-gray-600">Security documentation and resources coming soon.</p>
                        </div>
                    )}

                    {activeTab === 'subprocessors' && (
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                            <h2 className="text-2xl font-bold text-gray-900 mb-6">Subprocessors</h2>
                            <p className="text-gray-600">List of subprocessors and data handling information coming soon.</p>
                        </div>
                    )}
                    ...
                    {activeTab === 'updates' && (
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                            <h2 className="text-2xl font-bold text-gray-900 mb-6">Security Updates</h2>
                            <p className="text-gray-600">Security updates and changelog coming soon.</p>
                        </div>
                    )}
                </div>
            </div>
