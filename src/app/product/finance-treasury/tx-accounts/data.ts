export const productivityProps = {
    ...
    description:
        "TX Account automates the most complex aspects of digital treasury management—from cash positioning to cross-chain settlements—executing with precision and intelligence around the clock.",
    images: {
        mobile: {
    ...
    features: [
        {
            title: 'AI-Optimized Cash Management',
            description: 'Our system continuously monitors balances across all connected accounts and chains, automatically executing sweeps, rebalancing, and liquidity optimization to ensure optimal capital allocation without manual intervention.'
        },
        {
    ...
    testimonial: {
        quote:
            "TX Account reduced our daily treasury operations from 6 hours to 30 minutes while giving us complete visibility across 45 chains and 12 bank accounts. It's fundamentally changed how we manage our finances.",
        author: "Sarah Chen",
        role: "CFO of MultiChain Ventures",
        companyLogo: ` <svg
...
export const usabilityProps = {
    ...
    additionalFeatures: [
        ...
        },
        {
            ...
            description: 'Connect TX Account to your entire financial ecosystem:',
            list: {
                items: [
...
export const outboundProps = {
    ...
    g2Comparison: {
        title: "TX Account delivers enterprise-grade financial management",
        description:
            "",
        items: [
            ...
            { name: 'reduction in manual treasury operations', value: '70%', color: 'text-black/40' }
        ],
    },
    sectionStyle: {
