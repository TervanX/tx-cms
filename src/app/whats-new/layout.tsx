...
export default function WhatIsNewLayout({ children }: DashBoardLayoutProps) {
  return (
    <div className="flex flex-col lg:flex-row grow pt-[60px] lg:pt-12">
      <div className="flex flex-col grow items-stretch rounded-xl bg-background border border-gray mt-0 lg:mt-[15px] m-[15px]">
        <div
  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between flex-wrap gap-3 px-4">
        ...
        <button
          className="p-2 hover:bg-gray-200 rounded-lg transition-colors duration-200 -me-2"
        >
          <Menu size={20} />
        </button>
      </div>
