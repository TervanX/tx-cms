export const transportationLogisticsPageData = {
    heroSection: {
        heading: "Transportation & Logistics",
        subheading: "Revolutionizing global supply chains with blockchain intelligence",
        tag: "",
        primaryButton: {
            text: "Login",
            href: "/auth/login",
    ...
    subsection1: {
        title: "Transform logistics with blockchain-powered visibility",
    },
    ...
    insightCards: [
        {
            ...
            description:
                "Immutable tracking from manufacturer to end-customer with real-time visibility across all transport modes.",
        },
        {
            step: "02",
            title: "Automated documentation & compliance",
            description:
                "Streamline customs clearance, bills of lading, and regulatory compliance with smart contracts.",
        },
        {
            step: "03",
            title: "Supply chain finance optimization",
            description:
                "Accelerate payments, reduce financing costs, and improve cash flow across the supply chain.",
        },
    ],
    ...
    callAndConversation: {
        ...
        alignLeft: true,
        title: "Paperless logistics operations",
        ...
        cards: [
            {
                ...
                lists: [
                    ...
                    "Air cargo management and compliance",
            ...
            },
            {
                ...
                lists: [
                    ...
                    "Smart contract-powered agreements",
        ...
        cards: [
            {
                ...
                lists: [
                    "Real-time tracking updates (<30 seconds)",
                    "99.99% system uptime SLA",
                    "Process 1M+ shipments simultaneously",
        ...
        cards: [
            {
                ...
                lists: [
                    ...
                    "Carrier management and payment",
        ...
        cards: [
            ...
            },
            {
                ...
                lists: [
                    ...
                    "35% reduction in financing costs",
            ...
            },
            {
                ...
                lists: [
                    ...
                    "30% less paperwork and printing",
                    "40% improved recycling rates"
                ]
            }
        ],
        backgroundImage: "/assets/image30.webp",
        ...
        cards: [
            {
                ...
                lists: [
                    ...
                    "Authorized Economic Operator (AEO) standards",
            ...
            },
            {
                ...
                lists: [
                    ...
                    "US FDA and USDA import requirements",
                    "Asia-Pacific trade agreement compliance",
            ...
            },
            {
                ...
                lists: [
                    ...
                    "Blockchain in Transport Alliance (BiTA) standards",
                    "Digital Container Shipping Association (DCSA) standards"
                ]
            }
        ],
        backgroundImage: "/assets/image30.webp",
    ...
    testimonial: {
        title: "Logistics Leader Testimonials",
        quote:
            "We've achieved 99.9% shipment visibility and reduced cargo losses by 75%. The smart contract payments improved our carrier relationships with instant, transparent settlements.",
        role: "COO of Global Logistics Provider",
        name: "James Kim, ",
    },
