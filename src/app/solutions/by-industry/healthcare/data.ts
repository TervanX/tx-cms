export const healthcarePageData = {
    heroSection: {
        heading: "Healthcare",
        subheading: "Transforming healthcare with secure, efficient blockchain solutions",
        tag: "",
        primaryButton: {
            text: "Login",
            href: "/auth/login",
    ...
    subsection1: {
        title: "Modernize healthcare operations with blockchain technology",
    },
    ...
    insightCards: [
        {
            ...
            description:
                "Protect patient records with immutable blockchain storage and granular access controls.",
        },
        {
            step: "02",
            title: "Streamlined medical payments",
            description:
                "Process insurance claims, patient payments, and cross-border medical transactions with unprecedented efficiency.",
        },
        {
            step: "03",
            title: "Supply chain integrity",
            description:
                "Track pharmaceuticals, medical devices, and supplies with complete provenance and authenticity verification.",
        },
    ],

    subsection2: {
        title: "Secure, interoperable patient records",
        description: "",
    ...
    callAndConversation: {
        ...
        alignLeft: true,
        title: "Efficient healthcare financial operations",
        tag: "Medical Payments & Insurance",
        description: "",
        cards: [
            {
    ...
    liveChat: {
        title: "End-to-end medication tracking",
        ...
        cards: [
            {
                ...
                lists: [
                    ...
                    "Scalable to millions of patient records"
                ]
            },
            {
                title: " Security",
    ...
    globalWhatsapp10: {
        ...
        cards: [
            ...
            },
            {
                ...
                lists: [
                    "$9,999 per month",
                    "Up to 1 million patient records",
    ...
    engageCustomers: {
        badgeText: "Telemedicine & Remote Care",
        title: "Digital health transformation",
        columns: [
            {
                title: "Secure telemedicine platforms",
