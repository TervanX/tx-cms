export const ecommercePageData = {
    heroSection: {
        heading: "E-commerce",
        subheading: "Powering the future of online commerce with blockchain payments",
        tag: "",
        primaryButton: {
            text: "Login",
            href: "/sign-up",
    ...
    subsection1: {
        title: "Transform online payments with blockchain technology",
    },

    insightCards: [
        {
            step: "01",
            title: "Crypto payment acceptance",
            description:
                "Accept 100+ cryptocurrencies with instant settlement and automatic fiat conversion.",
        },
        {
            step: "02",
            title: "Global payment expansion",
            description:
                "Reach customers in 200+ countries without traditional banking limitations.",
        },
        {
            step: "03",
            title: "Reduced transaction costs",
            description:
                "Cut payment processing fees by up to 80% compared to traditional payment methods.",
        },
    ],

    subsection2: {
        title: "Seamless crypto payment integration",
        description: "",
    ...
    liveChat: {
        title: "Frictionless shopping journeys",
        ...
        cards: [
            {
                ...
                lists: [
                    ...
                    "Scalable for flash sales and peak traffic"
                ]
            },
            {
                title: "Security",
        ...
        cards: [
            ...
            },
            {
                ...
                lists: [
                    ...
                    "90% reduction in chargeback costs",
                    "60% decrease in cross-border fees",
            ...
            },
            {
                ...
                lists: [
                    ...
                    "40% growth in emerging market revenue",
        ...
        cards: [
            ...
            },
            {
                ...
                lists: [
                    ...
                    "Custom loyalty token implementation",
                    "Supply chain integration",
