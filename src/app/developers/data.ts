export const supportData = {
    ...
    testimonialdata: {
        ...
        title: "See why startups love Apollo",
        description: "Check out how other teams save time & money with the easiest all-in-one sales platform."
    },
    resourcesdata: {
        cards: [
            {
    ...
    faqData: [
        {
            ...
            answer: `You must be a new Apollo user affiliated with one of our startup ecosystem partners, have less than 20 employees, and a valid corporate domain.`,
        },
        {
            question: 'What if my startup is not affiliated with a startup ecosystem partner?',
            answer: `Encourage your accelerator, VC firm, or community to <a href="/product/sales-engagement" class="underline">join here</a>. You can also <a href="/product/sales-engagement" class="hover:underline">apply here</a> to join our waitlist for the Apollo for Startups community.`,
        },
        {
            question: 'I want this discount to be available to my startup community. How can I become a partner?',
            answer: `We want to hear from you! <a href="/product/sales-engagement" class="underline">Apply to be a partner</a> and we'll get back to you with more information.`,
        },
        {
            question: 'I still have questions. Who can I reach out to?',
            answer: `For any additional support, questions, or feedback — feel free to contact us at <a href="mailto:startups@apollo.io" class="underline">startups@apollo.io</a>. We can't wait to grow with you 🎉`,
        },
    ],
    marqueedata: {
        marqueeItems: [
